...
CREATE TABLE `records` (
  ...
  `book_id` int(10) NOT NULL foreign key (book_id) REFERENCES books(book_id),
  `user_id` int(10) NOT NULL,
  `date` date NOT NULL,
  `isbn` varchar(100) NOT NULL
);
...
(1, 1001, 1801038, '2021-01-11','AJGUIGIUH'),
(2, 1002, 1801109, '2021-02-13','SRGBSORIH'),
(3, 1001, 1801038, '2021-03-09','UFGUEGAUU'),
(4, 1003, 1801004, '2021-04-07','IEFHPSIHI'),
(5, 1004, 1801059, '2021-05-24','IOHGRIFES'),
(6, 1005, 1801004, '2021-06-22','IGORISBII'),
(7, 1004, 1801109, '2021-07-25','POTKHDTDN'),
(8, 1006, 1801038, '2021-08-19','LRNSSKKRR'),
(9, 1003, 1801059, '2021-09-10','EFSHUFOII');
-- --------------------------------------------------------
