        ...
        if(!errors){
            userModel.createUser(data, (result)=> {
                if(!result){
                    ...
                    console.log(result);
                    res.render('admin/students-add', {errs: [], success: [{message: "Customer added successfully!"}], data: []});
                }
            });
        }
        else {
        ...
        if(!errors){
            userModel.updateCustomer(customer_id, data, (result)=> {
                if(!result){
                    ...
                    console.log(result);
                    res.render('admin/students-edit', {res: result, errs:[], success: [{message: "Customer updated successfully!"}]});
                }
            });
        }
        else {
